        ...
        match opcode {
            x if x == Instruction::CMP as u8 => {
                ...
                instr_log = format!(
                    ...
                    self.pc, instr_name, opcode, self.acc, addr, val
                );
            ...
            x if x == Instruction::STA as u8 => {
                ...
                instr_log = format!(
                    "{:04}: {} (0x{:02X}) acc={} -> addr={}",
                    self.pc, instr_name, opcode, self.acc, addr
                );
            ...
            x if x == Instruction::ADD as u8 => {
                ...
                instr_log = format!(
                    ...
                    self.pc, instr_name, opcode, self.acc, val, addr
                );
            ...
            x if x == Instruction::JMP as u8 => {
                ...
                instr_log = format!(
                    "{:04}: {} (0x{:02X}) to addr={}",
                    self.pc, instr_name, opcode, addr
                );
            ...
            x if x == Instruction::JZ as u8 => {
                ...
                instr_log = format!(
                    ...
                    self.pc, instr_name, opcode, addr, self.acc
                );
